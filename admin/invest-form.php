            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-lg">
                    <div class="nk-block-head-content">
                        <div class="nk-block-head-sub"><a href="html/invest/invest.php" class="back-to"><em
                                        ...
                                        <a href="#" class="invest-cc-chosen dropdown-indicator"
                                            ...
                                            <div class="coin-item">
                                                ...
                                                <div class="coin-info">
                                                    ...
                                                    <span class="coin-text">Invest for 21 days and get daily
                                                        profit 4.76%</span>
                                                </div>
                                            </div>
                                        </a>
                                                ...
                                                <li class="invest-cc-item selected">
                                                    <a href="#" class="invest-cc-opt" data-plan="silver">
                                                        <div class="coin-item">
                                                            ...
                                                            <div class="coin-info">
                                                                <span class="coin-name">Silver Plan</span>
                                                                <span class="coin-text">Invest for 21 days
                                                                    and get daily profit 4.76%</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                    ...
                                                    <a href="#" class="invest-cc-opt" data-plan="starter">
                                                        <div class="coin-item">
                                                            ...
                                                            <div class="coin-info">
                                                                ...
                                                                <span class="coin-text">Invest for 30 days
                                                                    and get daily profit 1.67%</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                    ...
                                                    <a href="#" class="invest-cc-opt" data-plan="dimond">
                                                        <div class="coin-item">
                                                            ...
                                                            <div class="coin-info">
                                                                ...
                                                                <span class="coin-text">Invest for 14 days
                                                                    and get daily profit 14.29%</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                ...
                                <div class="card card-bordered ms-lg-4 ms-xl-0">
                                    <div class="nk-iv-wg4">
                                        ...
                                        <div class="nk-iv-wg4-sub text-center bg-lighter">
                                            <a class="btn btn-lg btn-primary ttu" data-bs-toggle="modal"
                                                href="#invest-plan">Confirm &amp; proceed</a>
                                        </div><!-- .nk-iv-wg4-sub -->
                                    </div><!-- .nk-iv-wg4 -->
                                </div><!-- .card -->
                            </div><!-- .col -->
